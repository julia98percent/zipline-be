...
public class PropertyArticleViewSpecification {
  ...
  public static Specification<PropertyArticle> buildingNameContains(String buildingName) {
    return (root, query, criteriaBuilder) ->
        buildingName == null ? null
            : criteriaBuilder.like(root.get("buildingName"), "%" + buildingName + "%");
  }
   ...
   * 등록일 범위로 검색하는 명세
   */
  public static Specification<PropertyArticle> createdAtBetween(LocalDateTime startDate,
