...
public interface CounselRepository extends JpaRepository<Counsel, Long>, QCounselRepository {
  ...
  Page<Counsel> findByCustomerUidAndUserUidAndDeletedAtIsNullOrderByCreatedAtDesc(Long customerUid,
  ...
  Page<Counsel> findByUserUidAndAgentPropertyUidAndDeletedAtIsNull(Long userUid, Long propertyUid,
      Pageable pageable);
}