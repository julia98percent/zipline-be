...
public class Contract extends BaseTimeEntity {
  ...
  @Builder
  private Contract(User user, PropertyType category, BigInteger deposit, BigInteger monthlyRent,
      BigInteger price,
      ...
      AgentProperty agentProperty, String other) {
    this.user = user;
  ...
  public void modifyContract(PropertyType category, BigInteger deposit, BigInteger monthlyRent,
      BigInteger price,
